...
from custom_dataset import Dataset_Return_Four
...
def unet_train(epochs, gpu, base_model_name, encoder_weights, generator_lr, discriminator_lr, lambda_bce, threshold,
    ...
    # make save directory
    weight_path = './step1_dibco_' + base_model_name + '_' + str(int(lambda_bce)) + '_' + str(generator_lr) + '_' + str(threshold)
...
if __name__ == "__main__":
    ...
    # data set
    parser.add_argument('--image_train_dir', type=str, default='/data/denoise/deep_standard/train/image_patches/', help='patched image train dir')
    parser.add_argument('--mask_train_dir', type=str, default='/data/denoise/deep_standard/train/mask_patches/', help='patched mask train dir')
