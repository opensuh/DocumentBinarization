...
from custom_dataset import Dataset_Return_One
...
def unet_train(epochs, gpu, base_model_name, encoder_weights, generator_lr, discriminator_lr, lambda_bce,
    ...
    # make directory
    weight_path = './step2_dibco_' + base_model_name + '_' + str(int(lambda_bce)) + '_' + str(generator_lr)
...
if __name__ == "__main__":
    ...
    # data set
    parser.add_argument('--image_train_dir', type=str, default='./predicted_image_for_step2_dibco/train/patch/image/', help='patched step1 prdiction image train dir')
    parser.add_argument('--mask_train_dir', type=str, default='./predicted_image_for_step2_dibco/train/patch/mask/', help='patched step1 prdiction mask train dir')
    parser.add_argument('--image_test_dir', type=str, default='./predicted_image_for_step2_dibco/test/', help='step1 prdiction image test dir')
