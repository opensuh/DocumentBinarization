...
def unet_train(epochs, gpu, base_model_name, encoder_weights, generator_lr, discriminator_lr, lambda_bce,
    ...
    weight_path = './step2_resize_dibco_' + base_model_name + '_' + str(int(lambda_bce)) + '_' + str(generator_lr)
...
if __name__ == "__main__":
    ...
    # data set
    parser.add_argument('--image_train_dir', type=str, default='/data/denoise/dibco_resize_6_4/train/image', help='512 resized image train dir')
    parser.add_argument('--mask_train_dir', type=str, default='/data/denoise/dibco_resize_6_4/train/mask', help='512 resized mask train dir')
