...
from custom_dataset_label import Dataset_Return_Four
...
def unet_train(epochs, gpu, base_model_name, encoder_weights, generator_lr, discriminator_lr, lambda_bce, threshold,
    ...
    # make save directory
    weight_path = ('./step1_label%d_' % fold_num) + base_model_name + '_' + str(int(lambda_bce)) + '_' + str(generator_lr) + '_' + str(threshold)
    ...
    train_data_set = Dataset_Return_Four(image_train_dir, mask_train_dir, os.path.join(original_dir, 'image'),
...
if __name__ == "__main__":
    ...
    # data set
    parser.add_argument('--image_train_dir', type=str, default='/data/denoise/Label_patch/image_patches/', help='patched image train dir')
    parser.add_argument('--mask_train_dir', type=str, default='/data/denoise/Label_patch/mask_patches/', help='patched mask train dir')
