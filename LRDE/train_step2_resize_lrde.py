...
def unet_train(epochs, gpu, base_model_name, encoder_weights, generator_lr, discriminator_lr, lambda_bce,
    ...
    train_data_set = Dataset_Return_One_LRDE(image_train_dir, mask_train_dir, os.path.join(original_dir, 'image'),
    ...
    weight_path = ('./step2_resize_lrde_%d_' % fold_num) + base_model_name + '_' + str(int(lambda_bce)) + '_' + str(generator_lr)
...
if __name__ == "__main__":
    ...
    # data set
    parser.add_argument('--image_train_dir', type=str, default='/data/denoise/LRDE/resize/image/', help='512 resized image train dir')
    parser.add_argument('--mask_train_dir', type=str, default='/data/denoise/LRDE/resize/mask/', help='512 resized mask train dir')
