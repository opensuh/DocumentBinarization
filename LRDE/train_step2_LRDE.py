...
from custom_dataset_LRDE import Dataset_Return_One_LRDE
...
def unet_train(epochs, gpu, base_model_name, encoder_weights, generator_lr, discriminator_lr, lambda_bce,
    ...
    weight_path = ('./step2_LRDE%d_' % fold_num) + base_model_name + '_' + str(int(lambda_bce)) + '_' + str(generator_lr)
    ...
    # patch data loader
    patch_train_data_set = Dataset_Return_One_LRDE(image_train_dir, mask_train_dir, os.path.join(original_dir, 'image'),
...
if __name__ == "__main__":
    ...
    # data set
    parser.add_argument('--image_train_dir', type=str, default='./predicted_image_for_step2_lrde_%d/train/patch/image', help='patched step1 prdiction image train dir')
    parser.add_argument('--mask_train_dir', type=str, default='./predicted_image_for_step2_lrde_%d/train/patch/mask', help='patched step1 prdiction mask train dir')
    parser.add_argument('--image_test_dir', type=str, default='./predicted_image_for_step2_lrde_%d/test', help='step1 prdiction image test dir')
